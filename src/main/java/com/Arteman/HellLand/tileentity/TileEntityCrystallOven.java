...
public class TileEntityCrystallOven extends TileEntity implements ISidedInventory
{
	...
	public void updateEntity()
	{
        ...
        if(!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                CrystallOven.updateCrystallOvenBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
        if (flag1)
        {
