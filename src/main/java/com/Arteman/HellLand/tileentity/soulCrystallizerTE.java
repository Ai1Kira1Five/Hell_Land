...
public class soulCrystallizerTE extends tileEntityWithInventory{
    ...
    public soulCrystallizerTE(){
        super(3);
    }

    @Override
    public boolean isItemValidForSlot(int i, ItemStack itemstack) {
        return i != 2 && (i != 1 || TileEntityFurnace.isItemFuel(itemstack));
    }
    ...
    public boolean canSmelt() {
        if (this.inventory[0] == null) {
            ...
            ItemStack itemstack = CrystallizerRecipes.crystallizing().getCrystallResult(this.inventory[0]);
