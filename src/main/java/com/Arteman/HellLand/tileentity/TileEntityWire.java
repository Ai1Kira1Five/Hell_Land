...
public class TileEntityWire extends TileEntity 
{
	...
	public void updateConnections()
	{
		...
		if(isWire(xCoord, yCoord, zCoord-1) || isHellOven(xCoord, yCoord, zCoord-1)) connections[2] = ForgeDirection.NORTH;
		else connections[2] = null;
		if(isWire(xCoord+1, yCoord, zCoord) || isHellOven(xCoord+1, yCoord, zCoord)) connections[3] = ForgeDirection.EAST;
		else connections[3] = null;
		if(isWire(xCoord, yCoord, zCoord+1) || isHellOven(xCoord, yCoord, zCoord+1)) connections[4] = ForgeDirection.SOUTH;
		else connections[4] = null;
		if(isWire(xCoord-1, yCoord, zCoord) || isHellOven(xCoord-1, yCoord, zCoord)) connections[5] = ForgeDirection.WEST;
