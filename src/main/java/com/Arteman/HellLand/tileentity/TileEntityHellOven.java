...
public class TileEntityHellOven extends TileEntity implements ISidedInventory
{
	...
	{
		return this.hasCustomInventoryName() ? this.localizedName : "container.ContainerHellOven";
	}
