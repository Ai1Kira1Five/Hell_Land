...
public class SoulCrystallizer extends BlockContainer
{
	private final boolean isAct2;
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		if(isAct2)
		{
			this.iconFront = iconRegister.registerIcon(HellLand.MODID + ":" + "SoulCrystallizerFrontOn");
		}else{
			this.iconFront = iconRegister.registerIcon(HellLand.MODID + ":" + "SoulCrystallizerFrontOff");
		}
	...
	private String name = "Soul Crystallizer";
	
	private static boolean keepInventory;
	private Random rand = new Random();
	
	public SoulCrystallizer(boolean isAct2)
	{
		super(Material.rock);
		this.isAct2 = isAct2;
	...
	{
		return Item.getItemFromBlock(ModBlocks.SoulCrystallizer);
	}
	...
	{
		return new TileEntitySoulCrystallizer();
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack)
    {
        ...
        {
            ((TileEntitySoulCrystallizer)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
        }
        
        
    }

	public static void updateSoulCrystallizerBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	    {
	        ...
	        if (active)
	        {
	            worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.SoulCrystallizer);
	        }
	        else
	        {
	            worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.SoulCrystallizer);
	...
	public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata)
    {
        if (!keepInventory)
        {
            TileEntitySoulCrystallizer tileentity = (TileEntitySoulCrystallizer) world.getTileEntity(x, y, z);
