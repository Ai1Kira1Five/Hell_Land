...
public final class DataUtil {
	...
	public static NBTTagCompound readTag(DataInput input, NBTSizeTracker tracker)
		    throws IOException{
	...
	public static NBTTagCompound readTag(DataInput input)
		    throws IOException{
		return readTag(input, NBTSizeTracker.field_152451_a);
	}
	
	public static ItemStack readStack(DataInput input)
			throws IOException{
		return readStack(input, NBTSizeTracker.field_152451_a);
	}
	
	public static NBTTagCompound readTag(ByteBuf input)
		    throws IOException{
