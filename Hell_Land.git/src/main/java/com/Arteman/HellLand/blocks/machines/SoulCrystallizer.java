...
public class SoulCrystallizer extends BlockContainer
{
	...
	{
		return Item.getItemFromBlock(ModBlocks.SoulCrystallizerIdle);
	}
	...
	public static void updateSoulCrystallizerBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) 
	    {
	        ...
	        if (active)
	        {
	            worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.SoulCrystallizerActive);
	        }
	        else
	        {
	            worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.SoulCrystallizerIdle);
	        }
